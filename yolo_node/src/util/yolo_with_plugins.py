...
try:
    ctypes.cdll.LoadLibrary('/home/nvidia/xycar_ws/src/yolo_node/src/plugins/libyolo_layer.so')
except OSError as e:
...
class TrtYOLO(object):
    ...
    def _load_engine(self):
        TRTbin = '/home/nvidia/xycar_ws/src/yolo_node/yolo/%s.trt' % self.model
